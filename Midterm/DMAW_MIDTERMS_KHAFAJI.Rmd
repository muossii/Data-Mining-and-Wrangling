...
```
We can see that the model did better than the last, getting a better result (R^2 = 0.00066, p-val = 0.084). 
...
the cp value of 0.0006029685 had the lowest accuracy (0.7148369), Recall (0.9652995), and F-stat (0.8314882), but it has the highest precision (0.7305843). It is also the most complex iteration of the model.

The model that the caret library deemed optimal is the cp value of 0.0007168157, giving the highest accuracy (0.7214809), recall (0.9807560), and F statistic (0.8369769), with the least complexity.
